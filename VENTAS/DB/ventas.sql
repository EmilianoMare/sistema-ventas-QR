...
CREATE TABLE `usuario` (
  ...
  `caja_id` int(5) NOT NULL,
  `usuario_permisos` text COLLATE utf8_spanish2_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_spanish2_ci;
...
(1, 'Administrador', 'Principal', '', 'Administrador', '$2y$10$Jgm6xFb5Onz/BMdIkNK2Tur8yg/NYEMb/tdnhoV7kB1BwIG4R05D2', '', 1, 'dashboard,reportes,cajas,usuarios,clientes,categorias,productos,ventas,cc,config');
