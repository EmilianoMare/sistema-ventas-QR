<section class="full-width navLateral scroll" id="navLateral">
	<div class="full-width navLateral-body">
		<div class="full-width navLateral-body-logo has-text-centered tittles is-uppercase" style="position:relative;">
			Sistema de ventas 
			<!-- Collapse toggle -->
			<button id="btn-collapse-menu" class="button is-white is-small" aria-pressed="false" title="Colapsar menú" style="position:absolute;right:8px;top:6px;border-radius:4px;border:0;box-shadow:none;">
		...
		<figure class="full-width" style="height: 77px;">
            ...
            <?php $permisos = isset($_SESSION['permisos'])?$_SESSION['permisos']:array(); ?>
		...
		<nav class="full-width">
			<ul class="full-width list-unstyle menu-principal">
				...
				<?php if($_SESSION['id']==1 || in_array('dashboard',$permisos)): ?>
				<li class="full-width">
				...
				<?php if($_SESSION['id']==1 || in_array('reportes',$permisos)): ?>
				<?php if($_SESSION['id']==1 || in_array('cajas',$permisos)): ?>
				<?php if($_SESSION['id']==1 || in_array('usuarios',$permisos)): ?>
				<?php if($_SESSION['id']==1 || in_array('clientes',$permisos)): ?>
				<?php if($_SESSION['id']==1 || in_array('categorias',$permisos)): ?>
				<?php if($_SESSION['id']==1 || in_array('productos',$permisos)): ?>
				<?php if($_SESSION['id']==1 || in_array('ventas',$permisos)): ?>
				<?php if($_SESSION['id']==1 || in_array('config',$permisos)): ?>
				<li class="full-width">
					...
					<ul class="full-width menu-principal sub-menu-options">
						<li class="full-width">
							<a href="<?php echo APP_URL; ?>reportes/" class="full-width">
								<div class="navLateral-body-cl">
				...
				<?php if($_SESSION['id']==1 || in_array('cc',$permisos)): ?>
				<li class="full-width">
				    <a href="<?php echo APP_URL; ?>ccClientes/" class="full-width">
				        <div class="navLateral-body-cl">
		...
		<li class="full-width divider-menu-h"></li>
					...
					<li class="full-width">
						<a href="<?php echo APP_URL; ?>scanner/" class="full-width">
							<div class="navLateral-body-cl"><i class="fas fa-qrcode fa-fw"></i></div>
							<div class="navLateral-body-cr">Scan Packages</div>
						</a>
					</li>

					<li class="full-width">
						<a href="<?php echo APP_URL; ?>logisticsSummary/" class="full-width">
							<div class="navLateral-body-cl"><i class="fas fa-truck fa-fw"></i></div>
							<div class="navLateral-body-cr">Logistics Summary</div>
						</a>
					</li>
