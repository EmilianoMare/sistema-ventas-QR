...
<div class="container pb-6 pt-6">
	...
	<form class="FormularioAjax form-row" action="<?php echo APP_URL; ?>app/ajax/categoriaAjax.php" method="POST" autocomplete="off" >
		  	...
		  	<div class="column">
		    	<div class="control">
                    <label for="categoria_nombre">Nombre <?php echo CAMPO_OBLIGATORIO; ?></label>
                   	<input id="categoria_nombre" class="input" type="text" name="categoria_nombre" value="<?php echo $datos['categoria_nombre']; ?>" pattern="[a-zA-Z0-9áéíóúÁÉÍÓÚñÑ ]{4,50}" maxlength="50" required >
				</div>
		  	</div>
		  	<div class="column">
		    	<div class="control">
                    <label for="categoria_ubicacion">Ubicación</label>
                   	<input id="categoria_ubicacion" class="input" type="text" name="categoria_ubicacion" value="<?php echo $datos['categoria_ubicacion']; ?>" pattern="[a-zA-Z0-9áéíóúÁÉÍÓÚñÑ ]{5,150}" maxlength="150" >
				</div>
		  	</div>
		</div>
