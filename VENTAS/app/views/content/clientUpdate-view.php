		...
		<div class="columns">
		  	...
		  	<div class="column">
		    	<div class="control">
					...
					<input class="input" type="text" name="cliente_numero_documento" value="<?php echo $datos['cliente_numero_documento']; ?>" data-pattern="[a-zA-Z0-9-]{7,30}" maxlength="30" required >
				</div>
		  	</div>
		</div>
		<div class="columns">
		  	...
		  	<div class="column">
		    	<div class="control">
					<label>Calle o dirección de casa <?php echo CAMPO_OBLIGATORIO; ?></label>
                   	<input class="input" type="text" name="cliente_direccion" value="<?php echo $datos['cliente_direccion']; ?>" data-pattern="[-a-zA-Z0-9áéíóúÁÉÍÓÚñÑ().,# ]{4,70}" maxlength="70" required >
				</div>
		  	</div>
		</div>
		<div class="columns">
		  	<div class="column">
		    	<div class="control">
					<label>Teléfono</label>
                   	<input class="input" type="text" name="cliente_telefono" value="<?php echo $datos['cliente_telefono']; ?>" data-pattern="[0-9()+]{8,20}" maxlength="20" >
				</div>
		  	</div>
		  	<div class="column">
		    	<div class="control">
