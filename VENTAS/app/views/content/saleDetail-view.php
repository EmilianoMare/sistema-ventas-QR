...
<div class="container pb-6 pt-6">
	...
	<div class="columns pb-6 pt-6">
		<p class="has-text-centered full-width">
			...
			<button type="button" class="button is-link is-light is-medium" onclick="print_invoice(\''.APP_URL.'app/pdf/remito.php?code='.$datos_venta['venta_codigo'].'\')" title="Imprimir remito Nro. '.$datos_venta['venta_id'].'" ><i class="fas fa-file-export fa-fw"></i> &nbsp; Imprimir remito</button>';
			?>
		</p>
	</div>
	<?php
