...
<div class="container pb-6 pt-6">
	...
	<div class="columns">
		<div class="column is-two-fifths">
			...
			<form class="FormularioAjax form-row" action="<?php echo APP_URL; ?>app/ajax/productoAjax.php" method="POST" autocomplete="off" >
		...
		<div class="column">
			...
			<form class="mb-6 has-text-centered FormularioAjax form-row" action="<?php echo APP_URL; ?>app/ajax/productoAjax.php" method="POST" enctype="multipart/form-data" autocomplete="off" >
