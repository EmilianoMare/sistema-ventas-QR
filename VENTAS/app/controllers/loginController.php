				    ...
				    if($this->verificarDatos("[a-zA-Z0-9$@.-]{7,100}",$clave)){
					    ...
					    if($check_usuario->rowCount()==1){
					    	...
					    	if($check_usuario['usuario_usuario']==$usuario && password_verify($clave,$check_usuario['usuario_clave'])){
					            ...
					            // Cargar permisos (array) en sesión
					            if(isset($check_usuario['usuario_permisos']) && $check_usuario['usuario_permisos']!=''){
					                $_SESSION['permisos'] = explode(',', $check_usuario['usuario_permisos']);
					            }else{
					                $_SESSION['permisos'] = [];
					            }
