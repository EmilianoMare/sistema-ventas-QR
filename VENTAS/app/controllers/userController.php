<?php
	...
	class userController extends mainModel{
		...
		public function registrarUsuarioControlador(){
			...
			# Permisos de acceso (checkboxes)
			if(isset($_POST['usuario_permisos']) && is_array($_POST['usuario_permisos'])){
				$permisos = implode(',', $_POST['usuario_permisos']);
			}else{
				$permisos = $datos['usuario_permisos'];
			}
		    ...
		    $usuario_datos_reg=[
				...
				,
				[
					"campo_nombre"=>"usuario_permisos",
					"campo_marcador"=>":Permisos",
					"campo_valor"=>$permisos
				]
			];
		...
		public function actualizarUsuarioControlador(){
			...
			// Añadir permisos al arreglo de actualización
			$usuario_datos_up[] = [
				"campo_nombre"=>"usuario_permisos",
				"campo_marcador"=>":Permisos",
				"campo_valor"=>$permisos
